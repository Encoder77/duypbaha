...
const Posts = sequelize.define( 'posts', {
    ...
    description_ru: { type: DataTypes.STRING(10000), allowNull: false },
    title_en: { type: DataTypes.STRING, allowNull: true },
    description_en: { type: DataTypes.STRING(10000), allowNull: false },
    description_tm: { type: DataTypes.STRING(10000), allowNull: false },
